...
aws cloudformation deploy --template-file deploy/packagedTemplate.yml --stack-name ${STACK_NAME}Stack --parameter-overrides APIName=${STACK_NAME} SiteURL=${SITE_URL} --capabilities CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND
