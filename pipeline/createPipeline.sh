...
aws cloudformation deploy --template-file ./deploy/packagedPipeline.yml --stack-name ${PROJECT_NAME}Stack --parameter-overrides ProjectName=${PROJECT_NAME} --capabilities CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND
