...
import {addFeedbackRequest, getFeedbackRequests, removeFeedbackRequest} from './apiCalls';
...
describe('Adding requests to the list', () => {
  ...
  it('Adds requests to the request list', async () => {
    addFeedbackRequest.mockResolvedValue({id: 9999, request: 'This is a request'});
    const component = shallow(<RequestsPage/>);
    await act(async () => {
